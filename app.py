...
REVIEW_DATA_FILE = "reviews_data.json" # <--- ไฟล์ใหม่สำหรับรีวิว
...
# ✨ โหลดรีวิวจากไฟล์ตอนเริ่มต้น
if "reviews" not in st.session_state:
    st.session_state.reviews = load_reviews() # <--- โหลดข้อมูลรีวิว

    

# ----------------------------------------------------------------------------------
# 🛠️ ฟังก์ชันสร้าง Google Maps URL
# ----------------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------------
# ❗ ฟังก์ชันหลักและตัวช่วย
# ----------------------------------------------------------------------------------
def set_search_from_button(query):
    """ตั้งค่า st.session_state.search_input_key และสั่ง Rerun"""
