...
def create_google_maps_url(name, town="ปราจีนบุรี"):
    # Note: ใช้ URL แบบหลอกสำหรับตัวอย่าง แต่ในโค้ดจริงจะสร้างลิงก์ไป Google Maps
    query = f"{name} {town}"
    encoded_query = urllib.parse.quote_plus(query)
    # URL จริงที่ควรใช้: return f"https://www.google.com/maps/search/?api=1&query={encoded_query}"
...
# -------------------------------
# 📦 ข้อมูลร้านอาหาร (เพิ่ม 2 ร้านใหม่ที่นี่)
# -------------------------------
restaurants_raw = [
    ...
    # 🌟 ร้านอาหารใหม่ 2 ร้านที่คุณร้องขอ 
    {"ชื่อร้าน": "บ้านฟ้าเคียงตะวัน", "ประเภท": "อาหารไทย / วิวทุ่งนา", "ราคา": "฿150–350", "เบอร์ติดต่อ": "081-998-1234", "Town": "เมืองปราจีนบุรี", "Map_URL_Override": "http://googleusercontent.com/maps.google.com/6"},
    {"ชื่อร้าน": "ครัวอ่างเก็บน้ำจักรพงษ์", "ประเภท": "อาหารป่า / ริมน้ำ", "ราคา": "฿200–400", "เบอร์ติดต่อ": "037-456-7890", "Town": "ศรีมหาโพธิ", "Map_URL_Override": "http://googleusercontent.com/maps.google.com/7"},
]

restaurants = []
for r in restaurants_raw:
    if "Map_URL_Override" in r and r["Map_URL_Override"]:
        # ใช้ Map_URL_Override สำหรับร้านที่ต้องการกำหนดเอง
        r["แผนที่"] = r["Map_URL_Override"] 
    else:
        # ใช้ฟังก์ชันสร้าง URL สำหรับร้านที่ไม่มี Map_URL_Override (ในตัวอย่างนี้คือร้านแรกๆ)
